...
export default function Background() {
  return (
    <div className = "background">
        ...
        <img src = {pokeball1}  alt = "pokeball" className = "pokeball pokeball2"/>
        <img src = {pokeball1}  alt = "pokeball" className = "pokeball pokeball3"/>
        <img src = {pokeball1}  alt = "pokeball" className = "pokeball pokeball4"/>
        <img src = {pokeball1}  alt = "pokeball" className = "pokeball pokeball5"/>
        <img src = {pokeball1}  alt = "pokeball" className = "pokeball pokeball6"/>
    </div>
  )
}
